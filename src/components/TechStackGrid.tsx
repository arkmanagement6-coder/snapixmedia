...
const technologies = [
  ...
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_20px_rgba(0,0,0,0.05)] group-hover:border-slate-200",
  ...
  },
  {
    name: "NodeJS",
    desc: "Backend Engine",
    glow: "group-hover:shadow-[0_0_20px_rgba(74,222,128,0.1)] group-hover:border-emerald-400/20",
  ...
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_20px_rgba(52,211,153,0.1)] group-hover:border-green-400/20",
  ...
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_20px_rgba(251,191,36,0.1)] group-hover:border-amber-400/20",
  ...
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_20px_rgba(96,165,250,0.1)] group-hover:border-blue-400/20",
  ...
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_20px_rgba(147,197,253,0.1)] group-hover:border-sky-300/20",
  ...
  },
  {
    ...
    glow: "group-hover:shadow-[0_0_20px_rgba(167,243,125,0.1)] group-hover:border-lime-400/20",
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto py-8">
      {technologies.map((tech, i) => (
        <motion.div
          ...
          className="group flex items-center gap-4 p-5 rounded-2xl bg-white border border-slate-200/80 hover:bg-slate-50 transition-all duration-300 shadow-sm group-hover:shadow-[0_10px_25px_rgba(124,58,237,0.08)] group-hover:border-neon-purple/35"
        >
          <div className={`${tech.iconColor} p-3 rounded-xl bg-slate-50 border border-slate-100 group-hover:scale-110 transition-transform duration-300`}>
            {tech.icon}
          </div>
          <div>
