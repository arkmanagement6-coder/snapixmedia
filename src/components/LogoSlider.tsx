...
const clientLogos = [
  {
    name: "TechFlow",
    icon: (
      <svg className="w-28 h-6 text-gray-500 hover:text-white transition-colors duration-300 fill-current" viewBox="0 0 100 24">
...
export default function LogoSlider() {
  ...
  return (
    <div className="relative w-full py-10 overflow-hidden border-y border-glass-border bg-[#020010]/30 select-none">
