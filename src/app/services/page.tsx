...
const serviceCategories = [
  {
    ...
    icon: Target,
    color: "from-purple-500/10 to-indigo-600/10 text-purple-400 border-purple-500/20",
    services: [
  ...
  },
  {
    ...
    icon: Search,
    color: "from-violet-500/10 to-fuchsia-600/10 text-violet-400 border-violet-500/20",
    services: [
  ...
  },
  {
    ...
    icon: Monitor,
    color: "from-indigo-500/10 to-purple-600/10 text-indigo-400 border-indigo-500/20",
    services: [
  ...
  },
  {
    ...
    icon: Sparkles,
    color: "from-fuchsia-500/10 to-pink-600/10 text-fuchsia-400 border-fuchsia-500/20",
    services: [
