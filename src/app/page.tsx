  ...
  return (
    <div className="relative min-h-screen bg-[#030014] text-[#ededed] overflow-x-hidden flex flex-col font-sans">
      ...
      <section className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden glow-grid">
        ...
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-radial from-neon-purple/10 to-transparent blur-[100px] pointer-events-none -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-radial from-neon-cyan/8 to-transparent blur-[80px] pointer-events-none translate-x-1/2 translate-y-1/2" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col items-center justify-center text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl leading-relaxed mb-10">
            We build high-performance websites, scalable custom applications, and data-driven marketing campaigns that accelerate conversion and scaling.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full">
            ...
            <Link
              href="/portfolio"
              className="w-full sm:w-auto px-8 py-4 rounded-full border border-glass-border bg-glass-card hover:bg-white/5 text-white text-sm font-semibold uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
              View Portfolio
            </Link>
          </div>
      ...
      <section className="relative py-12 bg-space-black/40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                icon: ArrowUpRight,
                color: "text-pink-400 bg-pink-400/5 border-pink-400/10",
              },
              {
              ...
              return (
                <GlassCard key={i} className="hover:border-neon-cyan/20 flex flex-col justify-between min-h-[200px]" hoverGlow>
                  ...
                  <Link
                    href="/services"
                    className="mt-6 text-xs font-semibold uppercase tracking-wider text-neon-cyan flex items-center gap-1 hover:underline w-fit"
                  >
                    Learn More
      ...
      <section className="relative py-20 px-6 bg-space-black/30 border-y border-glass-border">
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-xl">
              ...
              <p className="text-gray-400 text-sm">Review real metrics, web audits, and leads generated for our creative partners.</p>
            </div>
            <Link
              href="/portfolio"
              className="px-6 py-3 rounded-full border border-glass-border bg-glass-card hover:bg-white hover:text-black font-semibold text-xs uppercase tracking-wider transition-all duration-300 w-fit cursor-pointer"
            >
      ...
      {/* 6. PROCESS TIMELINE */}
      <section className="relative py-24 px-6 bg-[#020010]/20 border-t border-glass-border" id="process">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
      ...
      <section className="relative py-24 px-6 border-t border-glass-border bg-space-black/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-gray-400 text-sm">We build using performant frameworks and cloud systems to guarantee server scalability.</p>
          </div>
          <TechStackGrid />
        </div>
      </section>
      ...
      <section className="relative py-32 px-6 overflow-hidden border-t border-glass-border bg-gradient-to-b from-[#030014] to-[#010007]">
        <div className="absolute inset-0 bg-grid-pattern opacity-5" />
        {/* Glow light */}
        <div className="absolute top-1/2 left-1/2 w-[600px] h-[300px] rounded-full bg-radial from-neon-purple/10 to-transparent blur-[120px] pointer-events-none -translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center gap-8">
          ...
          <Link
            href="/contact"
            className="px-8 py-4 rounded-full bg-white text-black text-sm font-semibold uppercase tracking-wider hover:bg-gray-200 transition-all duration-300 flex items-center gap-2 group cursor-pointer shadow-xl"
          >
