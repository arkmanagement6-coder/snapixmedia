  ...
  return (
    <div className="relative min-h-screen bg-[#f8fafc] text-[#334155] overflow-x-hidden flex flex-col font-sans">
      ...
      <section className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden glow-grid">
        ...
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] rounded-full bg-radial from-neon-purple/25 to-transparent blur-[120px] pointer-events-none -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-radial from-neon-cyan/20 to-transparent blur-[100px] pointer-events-none translate-x-1/2 translate-y-1/2" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col items-center justify-center text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-650 max-w-2xl leading-relaxed mb-10 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                icon: CheckCircle2,
                color: "text-purple-700 bg-purple-100/40 border-purple-200/80",
              },
              {
                title: "Custom App Dev",
                desc: "Full-stack cloud-native applications for Android, iOS, and complex dashboard systems.",
                icon: ArrowRight,
                color: "text-indigo-700 bg-indigo-100/40 border-indigo-200/80",
              },
            ].map((service, i) => {
              ...
              return (
                <GlassCard key={i} className="hover:border-neon-purple/40 flex flex-col justify-between min-h-[200px]" hoverGlow>
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="text-sm text-slate-650 leading-relaxed font-medium">{service.desc}</p>
                  </div>
                  <Link
                    href="/services"
      ...
      <section className="relative py-32 px-6 overflow-hidden border-t border-purple-200 bg-gradient-to-br from-white via-purple-50/45 to-purple-100/40">
        <div className="absolute inset-0 bg-grid-pattern opacity-5" />
        {/* Glow light */}
        <div className="absolute top-1/2 left-1/2 w-[600px] h-[300px] rounded-full bg-radial from-neon-purple/25 to-transparent blur-[140px] pointer-events-none -translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center gap-8">
          ...
          <p className="text-slate-650 text-base sm:text-lg leading-relaxed max-w-2xl font-semibold">
