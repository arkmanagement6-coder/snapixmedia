...
export default function PrivacyPolicy() {
  return (
    <div className="relative min-h-screen bg-[#ffffff] text-[#334155] overflow-x-hidden flex flex-col font-sans">
      <MouseFollower />
      <Navbar />
      ...
      <main className="flex-1 pt-32 pb-20 px-6 max-w-4xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-4 border-b border-slate-200/60 pb-8 mb-10">
          ...
          <p className="text-slate-500 text-xs sm:text-sm flex items-center gap-1.5 font-semibold mt-1">
        ...
        <div className="flex flex-col gap-8 text-sm leading-relaxed text-slate-650 font-medium">
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-xl font-bold text-slate-900 font-display">4. Data Integrity and Security</h2>
            <p>
          ...
          <section className="mt-8 p-6 rounded-3xl bg-slate-50 border border-slate-200/80 flex flex-col gap-4">
            <h3 className="text-lg font-bold text-slate-900 font-display border-b border-slate-200/60 pb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-neon-purple shadow-xs">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-neon-blue shadow-xs">
              ...
              <div className="flex items-center gap-3 sm:col-span-2">
                <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-neon-purple shadow-xs shrink-0">
