...
export default function About() {
  return (
    <div className="relative min-h-screen bg-transparent text-slate-650 overflow-x-hidden flex flex-col font-sans">
      ...
      <section className="py-20 px-6 relative border-t border-slate-200/50">
      ...
      <section className="py-20 px-6 border-t border-slate-200/50 bg-[#f8fafc]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-sm font-medium">A collective of developers, visual designers, and growth hackers.</p>
          </div>
      ...
      <section className="py-20 px-6 border-t border-slate-200/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative border-l border-slate-200 pl-8 ml-4 flex flex-col gap-12">
            {milestones.map((item, i) => (
              <div key={i} className="relative">
                {/* Timeline node */}
                <span className="absolute -left-[41px] top-1.5 w-[18px] h-[18px] rounded-full bg-white border-2 border-neon-purple flex items-center justify-center shadow-sm">
