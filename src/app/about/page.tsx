      ...
      <section className="py-20 px-6 relative border-t border-white/5">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <GlassCard className="flex flex-col gap-4" hoverGlow>
            <div className="w-10 h-10 rounded-xl bg-purple-950/40 border border-purple-500/20 flex items-center justify-center text-neon-purple">
          ...
          <GlassCard className="flex flex-col gap-4" hoverGlow>
            <div className="w-10 h-10 rounded-xl bg-violet-950/40 border border-violet-500/20 flex items-center justify-center text-neon-purple">
          ...
          <GlassCard className="flex flex-col gap-4" hoverGlow>
            <div className="w-10 h-10 rounded-xl bg-indigo-950/40 border border-indigo-500/20 flex items-center justify-center text-neon-blue">
      ...
      <section className="py-20 px-6 border-t border-white/5 bg-slate-950/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-white mt-3 mb-4 font-display">Meet Our Core Team</h2>
            <p className="text-slate-400 text-sm">A collective of developers, visual designers, and growth hackers.</p>
          </div>
            ...
            {teamMembers.map((member, i) => (
              <GlassCard key={i} className="flex flex-col justify-between text-center items-center h-[340px]" hoverGlow>
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed mt-2">{member.bio}</p>
                </div>
                
                <div className="flex gap-4 mt-6">
                  {["LN", "GH"].map((social) => (
                    <span key={social} className="text-[10px] font-mono text-slate-450 hover:text-white cursor-pointer transition-colors duration-300">
                      {social}
                    </span>
                  ))}
                </div>
      ...
      <section className="py-20 px-6 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mt-3 mb-2 font-display">Awards & Milestones</h2>
          </div>
          ...
          <div className="relative border-l border-white/10 pl-8 ml-4 flex flex-col gap-12">
            {milestones.map((item, i) => (
              <div key={i} className="relative">
                {/* Timeline node */}
                <span className="absolute -left-[41px] top-1.5 w-[18px] h-[18px] rounded-full bg-[#090514] border-2 border-neon-purple flex items-center justify-center">
