...
const benefits = [
  {
    ...
    desc: "Work from anywhere in India. We operate asynchronously to respect focused scheduling.",
    icon: MapPin,
    color: "text-purple-400 bg-purple-950/40 border border-purple-500/10",
  },
  {
    title: "Learning Stipend",
    desc: "₹50,000 yearly allocation for textbooks, online courses, cloud certifications, and hardware upgrades.",
    icon: Sparkles,
    color: "text-violet-400 bg-violet-950/40 border border-violet-500/10",
  },
  {
    title: "Health & Wellness",
    desc: "Comprehensive health insurance coverage, mental health support, and gym memberships allowance.",
    icon: Heart,
